...
from routers.auto_data import router as auto_data_router
from routers.tire_rack import router as tire_rack_router
from routers.yahoo import router as yahoo_router
...
PREFIX='/carlet/api/v2'

app.include_router(auth_router, prefix=PREFIX)
app.include_router(vehicle_router, prefix=PREFIX)
app.include_router(auto_data_router, prefix=PREFIX)
app.include_router(tire_rack_router, prefix=PREFIX)
app.include_router(yahoo_router, prefix=PREFIX)
